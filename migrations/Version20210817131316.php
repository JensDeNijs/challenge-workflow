 ...
 */
final class Version20210817131316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, ticket_id_id INT NOT NULL, user_id_id INT NOT NULL, comment VARCHAR(700) NOT NULL, private TINYINT(1) NOT NULL, INDEX IDX_9474526C5774FDDC (ticket_id_id), INDEX IDX_9474526C9D86650F (user_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, status_id INT NOT NULL, created_by_id INT NOT NULL, assigned_to_id INT DEFAULT NULL, solved_by_id INT DEFAULT NULL, escalated TINYINT(1) NOT NULL, subject VARCHAR(255) NOT NULL, ticket_message VARCHAR(700) NOT NULL, date_closed DATE DEFAULT NULL, INDEX IDX_97A0ADA36BF700BD (status_id), INDEX IDX_97A0ADA3B03A8386 (created_by_id), INDEX IDX_97A0ADA3F4BD7827 (assigned_to_id), INDEX IDX_97A0ADA3D5A00226 (solved_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT FK_97A0ADA3D5A00226 FOREIGN KEY (solved_by_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP FOREIGN KEY FK_97A0ADA3D5A00226');
